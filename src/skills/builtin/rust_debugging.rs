        ...
        steps: vec![
            AgentStep {
                ...
                action: crate::action::StepAction::ToolCall {
                    tool: "shell_cargo_check".to_string(),
                    args: serde_json::json!({}),
                },
                guard_out: Guard::Compiles,
                verdict: Verdict::Automated(Guard::Compiles),
                tools: ToolSet::Allow(vec!["shell_cargo_check".to_string()]),
            ...
            AgentStep {
                ...
                action: crate::action::StepAction::ToolCall {
                    tool: "shell_cargo_test".to_string(),
                    args: serde_json::json!({}),
                },
                guard_out: Guard::TestsPass,
                verdict: Verdict::Automated(Guard::TestsPass),
                tools: ToolSet::Allow(vec!["shell_cargo_test".to_string()]),
                injection_protection: InjectionProtection::None,
                output_schema: None,
                dependencies: Vec::new(),
                parallel: false,
